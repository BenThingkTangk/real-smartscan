  ...
  try {
    ...
    const stripeResp = await fetch('https://api.stripe.com/v1/checkout/sessions', {
      ...
      body: new URLSearchParams({
        ...
        'success_url': `${process.env.NEXT_PUBLIC_SITE_URL || 'https://real-smartscan.com'}/#/dashboard?upgraded=1`,
        'cancel_url': `${process.env.NEXT_PUBLIC_SITE_URL || 'https://real-smartscan.com'}/#/membership`,
